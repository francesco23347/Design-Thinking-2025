...
| **Week 3** | ทำหน้าเว็บตามที่ออกแบบ | ตรวจสอบความถูกต้องและแก้ไขความผิดพลาด |
| **Week 4** | ตรวจสอบข้อมูลทั้งหมดและสรุปผล | ตรวจสอบข้อมูลทั้งหมดและสรุปผล |
...
**ศศิวิมล มงคลสวัสดิ์**
     ...
     จุดเด่นคือการบันทึกเป็นรูปภาพ เพราะในชีวิตจริงผู้คนมักจะแคปหน้าจอหรือบันทึกรูปตารางเรียนไว้ในมือถือเพื่อความสะดวก จุดที่ต้องระวังคือการจองเวลาทับซ้อนกัน ทำให้วิชาใหม่อาจไปแสดงผลทับวิชาเก่าในช่องเดียวกันได้
